...
function wasm_valtype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_valtype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
...
function wasmtime_memorytype_maximum(ty, max)
    ccall(
        ...
        Bool,
        (Ptr{wasm_memorytype_t}, Ptr{UInt64}),
        ty,
        max,
    )
end
...
function wasm_tabletype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_tabletype_vec_t}, Csize_t, Ptr{Ptr{wasm_tabletype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasm_globaltype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_globaltype_vec_t}, Csize_t, Ptr{Ptr{wasm_globaltype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasmtime_memorytype_minimum(ty)
    ccall(
        (:wasmtime_memorytype_minimum, libwasmtime),
        UInt64,
        (Ptr{wasm_memorytype_t},),
        ty,
    )
...
function wasm_valtype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_valtype_vec_t}, Csize_t, Ptr{Ptr{wasm_valtype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasm_globaltype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_globaltype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
...
function wasm_val_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_val_vec_t}, Csize_t, Ptr{wasm_val_t}),
        out,
        arg2,
        arg3,
    )
...
function wasm_functype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_functype_vec_t}, Csize_t, Ptr{Ptr{wasm_functype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasm_functype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_functype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
function wasmtime_config_cranelift_nan_canonicalization_set(arg1, arg2)
    ccall(
...
function wasm_tabletype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_tabletype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
...
function wasmtime_table_get(store, table, index, val)
    ccall(
        ...
        Bool,
        (Ptr{wasmtime_context_t}, Ptr{wasmtime_table_t}, UInt32, Ptr{wasmtime_val_t}),
        store,
        table,
        index,
        val,
...
function wasmtime_func_from_raw(context, raw, ret)
    ccall(
        ...
        Cvoid,
        (Ptr{wasmtime_context_t}, Csize_t, Ptr{wasmtime_func_t}),
        context,
        raw,
        ret,
    )
...
function wasmtime_config_epoch_interruption_set(arg1, arg2)
    ccall(
...
function wasm_frame_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_frame_vec_t}, Csize_t, Ptr{Ptr{wasm_frame_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasmtime_linker_define_instance(linker, store, name, name_len, instance)
    ccall(
        ...
        Ptr{wasmtime_error_t},
        (Ptr{wasmtime_linker_t}, Ptr{wasmtime_context_t}, Cstring, Csize_t, Ptr{Cint}),
        linker,
        store,
        name,
        name_len,
...
function wasmtime_wat2wasm(wat, wat_len, ret)
    ccall(
        ...
        Ptr{wasmtime_error_t},
        (Cstring, Csize_t, Ptr{wasm_byte_vec_t}),
        wat,
        wat_len,
        ret,
    )
...
function wasm_importtype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_importtype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
...
function wasm_externtype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_externtype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
...
function wasm_memorytype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_memorytype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
...
function wasm_externtype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_externtype_vec_t}, Csize_t, Ptr{Ptr{wasm_externtype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasm_importtype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_importtype_vec_t}, Csize_t, Ptr{Ptr{wasm_importtype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasmtime_memory_grow(store, memory, delta, prev_size)
    ccall(
        ...
        Ptr{wasmtime_error_t},
        (Ptr{wasmtime_context_t}, Ptr{wasmtime_memory_t}, UInt64, Ptr{UInt64}),
        store,
        memory,
        delta,
        prev_size,
...
function wasmtime_caller_export_get(caller, name, name_len, item)
    ccall(
        ...
        Bool,
        (Ptr{wasmtime_caller_t}, Cstring, Csize_t, Ptr{wasmtime_extern_t}),
        caller,
        name,
        name_len,
        item,
...
function wasm_exporttype_vec_new_uninitialized(out, arg2)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_exporttype_vec_t}, Csize_t),
        out,
        arg2,
    )
end
function wasmtime_module_new(engine, wasm, wasm_len, ret)
    ccall(
        ...
        Ptr{wasmtime_error_t},
        (Ptr{wasm_engine_t}, Ptr{UInt8}, Csize_t, Ptr{Ptr{wasmtime_module_t}}),
        engine,
        wasm,
        wasm_len,
        ret,
...
function wasm_memorytype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_memorytype_vec_t}, Csize_t, Ptr{Ptr{wasm_memorytype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasmtime_context_consume_fuel(context, fuel, remaining)
    ccall(
        ...
        Ptr{wasmtime_error_t},
        (Ptr{wasmtime_context_t}, UInt64, Ptr{UInt64}),
        context,
        fuel,
        remaining,
    )
...
function wasm_byte_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_byte_vec_t}, Csize_t, Ptr{wasm_byte_t}),
        out,
        arg2,
        arg3,
    )
...
function wasm_exporttype_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_exporttype_vec_t}, Csize_t, Ptr{Ptr{wasm_exporttype_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasmtime_context_fuel_consumed(context, fuel)
    ccall(
        ...
        Bool,
        (Ptr{wasmtime_context_t}, Ptr{UInt64}),
        context,
        fuel,
    )
end
function wasm_extern_vec_new(out, arg2, arg3)
    ccall(
        ...
        Cvoid,
        (Ptr{wasm_extern_vec_t}, Csize_t, Ptr{Ptr{wasm_extern_t}}),
        out,
        arg2,
        arg3,
    )
...
function wasmtime_externref_from_raw(context, raw)
    ccall(
        ...
        Ptr{wasmtime_externref_t},
        (Ptr{wasmtime_context_t}, Csize_t),
        context,
        raw,
    )
end
...
function wasmtime_module_validate(engine, wasm, wasm_len)
    ccall(
        ...
        Ptr{wasmtime_error_t},
        (Ptr{wasm_engine_t}, Ptr{UInt8}, Csize_t),
        engine,
        wasm,
        wasm_len,
    )
